 ...
 */
@Singleton
public class CloudLoadBalancersAddMembersToLoadBalancerStrategy implements AddMembersToLoadBalancerStrategy {
   ...
   @Inject
   protected CloudLoadBalancersAddMembersToLoadBalancerStrategy(CloudLoadBalancersClient client,
   ...
   public LoadBalancerMetadata addMembersToLoadBalancer(String id,
      ...
      //TODO: Add members to load balancer
