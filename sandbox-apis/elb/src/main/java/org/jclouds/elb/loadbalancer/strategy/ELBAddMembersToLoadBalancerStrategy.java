...
@Singleton
public class ELBAddMembersToLoadBalancerStrategy implements AddMembersToLoadBalancerStrategy {

   private final ELBClient client;
   private final Function<LoadBalancer, LoadBalancerMetadata> converter;

   @Inject
   protected ELBAddMembersToLoadBalancerStrategy(ELBClient client, Function<LoadBalancer, LoadBalancerMetadata> converter) {
   ...
   public LoadBalancerMetadata addMembersToLoadBalancer(String id,
      ...
      String name = parts[1];
      client.registerInstancesWithLoadBalancerInRegion(region, name, members);
      try {
